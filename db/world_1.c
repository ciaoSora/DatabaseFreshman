/*
Database "world_1" contains tables:
	city
	country
	countrylanguage
	sqlite_sequence
...
struct T_country {
	...
	char region[26];
	double surface_area;
	double indepdent_year;
	double population;
	double life_expectancy;
	double gnp;
	double gnp_old;
	char local_name[45];
	char government_form[45];
	char head_of_state[34];
	double capital;
	char code2[3];
};

struct T_countrylanguage {
...
country[] = {
	...
	{ "BLR",                                      "Belarus",        "Europe",            "Eastern Europe",   207600.0,  1991,   10236000, 68.0,   13714.0,      None,                                      "Belarus",                                     "Republic",              "Aljaksandr Lukašenka", 3520, "BY" },
	...
	{ "BVT",                                "Bouvet Island",    "Antarctica",                "Antarctica",       59.0,  None,          0, None,       0.0,      None,                                    "Bouvetøya",                "Dependent Territory of Norway",                          "Harald V", None, "BV" },
	...
	{ "CCK",                      "Cocos (Keeling) Islands",       "Oceania", "Australia and New Zealand",       14.0,  None,        600, None,       0.0,      None,                      "Cocos (Keeling) Islands",                       "Territory of Australia",                      "Elisabeth II", 2317, "CC" },
	...
	{ "COK",                                 "Cook Islands",       "Oceania",                 "Polynesia",      236.0,  None,      20000, 71.1,     100.0,      None,                             "The Cook Islands",     "Nonmetropolitan Territory of New Zealand",                      "Elisabeth II",  583, "CK" },
	...
	{ "CXR",                             "Christmas Island",       "Oceania", "Australia and New Zealand",      135.0,  None,       2500, None,       0.0,      None,                             "Christmas Island",                       "Territory of Australia",                      "Elisabeth II", 1791, "CX" },
	{ "CYM",                               "Cayman Islands", "North America",                 "Caribbean",      264.0,  None,      38000, 78.9,    1263.0,    1186.0,                               "Cayman Islands",                "Dependent Territory of the UK",                      "Elisabeth II",  553, "KY" },
	...
	{ "ESH",                               "Western Sahara",        "Africa",           "Northern Africa",   266000.0,  None,     293000, 49.8,      60.0,      None,                                 "As-Sahrawiya",                          "Occupied by Marocco",               "Mohammed Abdel Aziz", 2453, "EH" },
	...
	{ "FLK",                             "Falkland Islands", "South America",             "South America",    12173.0,  None,       2000, None,       0.0,      None,                             "Falkland Islands",                "Dependent Territory of the UK",                      "Elisabeth II",  763, "FK" },
	{ "FRA",                                       "France",        "Europe",            "Western Europe",   551500.0,   843,   59225700, 78.8, 1424285.0, 1392448.0,                                       "France",                                     "Republic",                    "Jacques Chirac", 2974, "FR" },
	{ "FRO",                                "Faroe Islands",        "Europe",          "Nordic Countries",     1399.0,  None,      43000, 78.4,       0.0,      None,                                      "Føroyar",                              "Part of Denmark",                      "Margrethe II",  901, "FO" },
	...
	{ "GIB",                                    "Gibraltar",        "Europe",           "Southern Europe",        6.0,  None,      25000, 79.0,     258.0,      None,                                    "Gibraltar",                "Dependent Territory of the UK",                      "Elisabeth II",  915, "GI" },
	{ "GIN",                                       "Guinea",        "Africa",            "Western Africa",   245857.0,  1958,    7430000, 45.6,    2352.0,    2383.0,                                       "Guinée",                                     "Republic",                     "Lansana Conté",  926, "GN" },
	{ "GLP",                                   "Guadeloupe", "North America",                 "Caribbean",     1705.0,  None,     456000, 77.0,    3501.0,      None,                                   "Guadeloupe",                "Overseas Department of France",                    "Jacques Chirac",  919, "GP" },
	...
	{ "GRD",                                      "Grenada", "North America",                 "Caribbean",      344.0,  1974,      94000, 64.5,     318.0,      None,                                      "Grenada",                      "Constitutional Monarchy",                      "Elisabeth II",  916, "GD" },
	{ "GRL",                                    "Greenland", "North America",             "North America",  2166090.0,  None,      56000, 68.1,       0.0,      None,                    "Kalaallit Nunaat/Grønland",                              "Part of Denmark",                      "Margrethe II",  917, "GL" },
	...
	{ "GUF",                                "French Guiana", "South America",             "South America",    90000.0,  None,     181000, 76.1,     681.0,      None,                             "Guyane française",                "Overseas Department of France",                    "Jacques Chirac", 3014, "GF" },
	{ "GUM",                                         "Guam",       "Oceania",                "Micronesia",      549.0,  None,     168000, 77.8,    1197.0,    1136.0,                                         "Guam",                                 "US Territory",                    "George W. Bush",  921, "GU" },
	{ "GUY",                                       "Guyana", "South America",             "South America",   214969.0,  1966,     861000, 64.0,     722.0,     743.0,                                       "Guyana",                                     "Republic",                    "Bharrat Jagdeo",  928, "GY" },
	{ "HKG",                                    "Hong Kong",          "Asia",              "Eastern Asia",     1075.0,  None,    6782000, 79.5,  166448.0,  173610.0,                          "Xianggang/Hong Kong",       "Special Administrative Region of China",                       "Jiang Zemin",  937, "HK" },
	...
	{ "KIR",                                     "Kiribati",       "Oceania",                "Micronesia",      726.0,  1979,      83000, 59.8,      40.7,      None,                                     "Kiribati",                                     "Republic",                     "Teburoro Tito", 2256, "KI" },
	...
	{ "LCA",                                  "Saint Lucia", "North America",                 "Caribbean",      622.0,  1979,     154000, 72.3,     571.0,      None,                                  "Saint Lucia",                      "Constitutional Monarchy",                      "Elisabeth II", 3065, "LC" },
	...
	{ "MCO",                                       "Monaco",        "Europe",            "Western Europe",        1.5,  1861,      34000, 78.8,     776.0,      None,                                       "Monaco",                      "Constitutional Monarchy",                       "Rainier III", 2695, "MC" },
	...
	{ "MDV",                                     "Maldives",          "Asia", "Southern and Central Asia",      298.0,  1965,     286000, 62.2,     199.0,      None,                      "Dhivehi Raajje/Maldives",                                     "Republic",              "Maumoon Abdul Gayoom", 2463, "MV" },
	...
	{ "MNP",                     "Northern Mariana Islands",       "Oceania",                "Micronesia",      464.0,  None,      78000, 75.5,       0.0,      None,                     "Northern Mariana Islands",                       "Commonwealth of the US",                    "George W. Bush", 2913, "MP" },
	...
	{ "MSR",                                   "Montserrat", "North America",                 "Caribbean",      102.0,  None,      11000, 78.0,     109.0,      None,                                   "Montserrat",                "Dependent Territory of the UK",                      "Elisabeth II", 2697, "MS" },
	{ "MTQ",                                   "Martinique", "North America",                 "Caribbean",     1102.0,  None,     395000, 78.3,    2731.0,    2559.0,                                   "Martinique",                "Overseas Department of France",                    "Jacques Chirac", 2508, "MQ" },
	...
	{ "MYT",                                      "Mayotte",        "Africa",            "Eastern Africa",      373.0,  None,     149000, 59.5,       0.0,      None,                                      "Mayotte",           "Territorial Collectivity of France",                    "Jacques Chirac", 2514, "YT" },
	{ "NAM",                                      "Namibia",        "Africa",           "Southern Africa",   824292.0,  1990,    1726000, 42.5,    3101.0,    3384.0,                                      "Namibia",                                     "Republic",                        "Sam Nujoma", 2726, "NA" },
	{ "NCL",                                "New Caledonia",       "Oceania",                 "Melanesia",    18575.0,  None,     214000, 72.8,    3563.0,      None,                           "Nouvelle-Calédonie",          "Nonmetropolitan Territory of France",                    "Jacques Chirac", 3493, "NC" },
	{ "NER",                                        "Niger",        "Africa",            "Western Africa",  1267000.0,  1960,   10730000, 41.3,    1706.0,    1580.0,                                        "Niger",                                     "Republic",                    "Mamadou Tandja", 2738, "NE" },
	{ "NFK",                               "Norfolk Island",       "Oceania", "Australia and New Zealand",       36.0,  None,       2000, None,       0.0,      None,                               "Norfolk Island",                       "Territory of Australia",                      "Elisabeth II", 2806, "NF" },
	...
	{ "NIU",                                         "Niue",       "Oceania",                 "Polynesia",      260.0,  None,       2000, None,       0.0,      None,                                         "Niue",     "Nonmetropolitan Territory of New Zealand",                      "Elisabeth II", 2805, "NU" },
	...
	{ "NRU",                                        "Nauru",       "Oceania",                "Micronesia",       21.0,  1968,      12000, 60.8,     197.0,      None,                                 "Naoero/Nauru",                                     "Republic",                  "Bernard Dowiyogo", 2728, "NR" },
	...
	{ "PRI",                                  "Puerto Rico", "North America",                 "Caribbean",     8875.0,  None,    3869000, 75.6,   34100.0,   32100.0,                                  "Puerto Rico",                       "Commonwealth of the US",                    "George W. Bush", 2919, "PR" },
	...
	{ "PYF",                             "French Polynesia",       "Oceania",                 "Polynesia",     4000.0,  None,     235000, 74.8,     818.0,     781.0,                          "Polynésie française",          "Nonmetropolitan Territory of France",                    "Jacques Chirac", 3016, "PF" },
	...
	{ "SHN",                                 "Saint Helena",        "Africa",            "Western Africa",      314.0,  None,       6000, 76.8,       0.0,      None,                                 "Saint Helena",                "Dependent Territory of the UK",                      "Elisabeth II", 3063, "SH" },
	{ "SJM",                       "Svalbard and Jan Mayen",        "Europe",          "Nordic Countries",    62422.0,  None,       3200, None,       0.0,      None,                        "Svalbard og Jan Mayen",                "Dependent Territory of Norway",                          "Harald V",  938, "SJ" },
	...
	{ "SOM",                                      "Somalia",        "Africa",            "Eastern Africa",   637657.0,  1960,   10097000, 46.2,     935.0,      None,                                   "Soomaaliya",                                     "Republic",           "Abdiqassim Salad Hassan", 3214, "SO" },
	{ "SPM",                    "Saint Pierre and Miquelon", "North America",             "North America",      242.0,  None,       7000, 77.6,       0.0,      None,                     "Saint-Pierre-et-Miquelon",           "Territorial Collectivity of France",                    "Jacques Chirac", 3067, "PM" },
	{ "STP",                        "Sao Tome and Principe",        "Africa",            "Central Africa",      964.0,  1975,     147000, 65.3,       6.0,      None,                          "São Tomé e Príncipe",                                     "Republic",                   "Miguel Trovoada", 3172, "ST" },
	...
	{ "TCA",                     "Turks and Caicos Islands", "North America",                 "Caribbean",      430.0,  None,      17000, 73.3,      96.0,      None,                 "The Turks and Caicos Islands",                "Dependent Territory of the UK",                      "Elisabeth II", 3423, "TC" },
	...
	{ "TMP",                                   "East Timor",          "Asia",            "Southeast Asia",    14874.0,  None,     885000, 46.0,       0.0,      None,                                  "Timor Timur",                      "Administrated by the UN",             "José Alexandre Gusmão", 1522, "TP" },
	...
	{ "TUV",                                       "Tuvalu",       "Oceania",                 "Polynesia",       26.0,  1978,      12000, 66.3,       6.0,      None,                                       "Tuvalu",                      "Constitutional Monarchy",                      "Elisabeth II", 3424, "TV" },
	...
	{ "VAT",                "Holy See (Vatican City State)",        "Europe",           "Southern Europe",        0.4,  1929,       1000, None,       9.0,      None,                "Santa Sede/Città del Vaticano",                     "Independent Church State",               "Johannes Paavali II", 3538, "VA" },
	{ "VCT",             "Saint Vincent and the Grenadines", "North America",                 "Caribbean",      388.0,  1979,     114000, 72.3,     285.0,      None,             "Saint Vincent and the Grenadines",                      "Constitutional Monarchy",                      "Elisabeth II", 3066, "VC" },
	...
	{ "VGB",                      "Virgin Islands, British", "North America",                 "Caribbean",      151.0,  None,      21000, 75.4,     612.0,     573.0,                       "British Virgin Islands",                "Dependent Territory of the UK",                      "Elisabeth II",  537, "VG" },
	{ "VIR",                         "Virgin Islands, U.S.", "North America",                 "Caribbean",      347.0,  None,      93000, 78.1,       0.0,      None,          "Virgin Islands of the United States",                                 "US Territory",                    "George W. Bush", 4067, "VI" },
	...
	{ "WLF",                            "Wallis and Futuna",       "Oceania",                 "Polynesia",      200.0,  None,      15000, None,       0.0,      None,                             "Wallis-et-Futuna",          "Nonmetropolitan Territory of France",                    "Jacques Chirac", 3536, "WF" },
	...
	{ "YUG",                                   "Yugoslavia",        "Europe",           "Southern Europe",   102173.0,  1918,   10640000, 72.4,   17000.0,      None,                                  "Jugoslavija",                             "Federal Republic",                "Vojislav Koštunica", 1792, "YU" },
