...
struct T_countries {
	...
	double region_id;	// --> regions.region_id
};

struct T_departments {
	double department_id;
	char department_name[21];
	double manager_id;
	double location_id;
};
...
struct T_locations {
	...
	char postal_code[13];
	char city[20];
	char state_province[18];
	char country_id[3];	// --> countries.country_id
};
