/*
Database "driving_school" contains tables:
	addresses
	customer_payments
	customers
	lessons
...
#ifndef DRIVING_SCHOOL
#define DRIVING_SCHOOL

struct T_addresses {
	double address_id;
	char line_1_number_building[32];
	char city[20];
	char zip_postcode[6];
	char state_province_county[13];
	char country[4];
};

struct T_customer_payments {
	double customer_id;	// --> customers.customer_id
	char datetime_payment[20];
...
struct T_customers {
	double customer_id;
	double customer_address_id;	// --> addresses.address_id
	char customer_status_code[14];
	...
	char cell_mobile_phone_number[21];
};

struct T_lessons {
	double lesson_id;
	double customer_id;	// --> customers.customer_id
	char lesson_status_code[10];
	double staff_id;	// --> staff.staff_id
	double vehicle_id;	// --> vehicles.vehicle_id
	char lesson_date[20];
	char lesson_time[2];
	double price;
};
...
struct T_staff {
	double staff_id;
	double staff_address_id;	// --> addresses.address_id
	char nickname[20];
	char first_name[10];
	char middle_name[11];
	char last_name[11];
	char date_of_birth[20];
	char date_joined_staff[20];
	char date_left_staff[20];
};

struct T_vehicles {
	double vehicle_id;
	char vehicle_details[6];
};
