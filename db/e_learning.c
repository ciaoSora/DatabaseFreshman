/*
Database "e_learning" contains tables:
...
struct T_course_authors_and_tutors {
	double author_id;
	char author_tutor_atb[4];
	char login_name[16];
	char password[41];
	...
	char family_name[10];
	char gender_mf[2];
	char address_line_1[58];
};

struct T_courses {
	double course_id;
	double author_id;	// --> course_authors_and_tutors.author_id
	double subject_id;	// --> subjects.subject_id
	char course_name[18];
	char course_description[18];
};

struct T_student_course_enrolment {
	double registration_id;
	double student_id;	// --> students.student_id
	double course_id;	// --> courses.course_id
	char date_of_enrolment[20];
	char date_of_completion[20];
};

struct T_student_tests_taken {
	double registration_id;	// --> student_course_enrolment.registration_id
	char date_test_taken[20];
	char test_result[5];
};

struct T_students {
	double student_id;
	char date_of_registration[20];
	char date_of_latest_logon[20];
	char login_name[15];
	char password[11];
	char personal_name[9];
	char middle_name[9];
	char family_name[11];
};
