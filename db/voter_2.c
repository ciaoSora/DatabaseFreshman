/*
Database "voter_2" contains tables:
	student
	voting_record
*/
...
struct T_voting_record {
	double student_id;	// --> student.student_id
	char registration_date[11];
	char election_cycle[7];
	double president_vote;	// --> student.student_id
	double vice_president_vote;	// --> student.student_id
	double secretary_vote;	// --> student.student_id
	double treasurer_vote;	// --> student.student_id
	double class_president_vote;	// --> student.student_id
	double class_senator_vote;	// --> student.student_id
};
