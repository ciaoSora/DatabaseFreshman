/*
Database "dog_kennels" contains tables:
	breeds
	charges
	dogs
	owners
...
struct T_dogs {
	double dog_id;
	double owner_id;	// --> owners.owner_id
	char abandoned_yes_or_no[2];
	char breed_code[4];	// --> breeds.breed_code
	char size_code[4];	// --> sizes.size_code
	char name[11];
	char age[2];
	char date_of_birth[20];
	char gender[2];
	char weight[5];
	char date_arrived[20];
	char date_adopted[20];
	char date_departed[20];
};
...
struct T_professionals {
	double professional_id;
	char role_code[13];
	char first_name[9];
	char street[51];
	char city[19];
...
struct T_sizes {
	char size_code[4];
	char size_description[7];
};

struct T_treatment_types {
	char treatment_type_code[5];
	char treatment_type_description[21];
};

struct T_treatments {
	double treatment_id;
	double dog_id;	// --> dogs.dog_id
	double professional_id;	// --> professionals.professional_id
	char treatment_type_code[5];	// --> treatment_types.treatment_type_code
	char date_of_treatment[20];
