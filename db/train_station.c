/*
Database "train_station" contains tables:
	station
	train
	train_station
*/
...
struct T_station {
	double station_id;
	char name[24];
	double annual_entry_exit;
	double annual_interchanges;
	double total_passengers;
	char location[11];
	char main_services[51];
	double number_of_platforms;
};
...
struct T_train_station {
	double train_id;	// --> train.train_id
	double station_id;	// --> station.station_id
};
